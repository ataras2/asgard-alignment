...
def get_matricies(config):
    ...
    if config == "c_red_one_focus":
        ...
        #}
        pup_img_mat = {
            1: np.array([[0.49083, -0.00082], [-0.20512, 0.00082]]),
            2: np.array([[0.55313, -0.00093], [-0.26742, 0.00093]]),
            3: np.array([[0.61979, -0.00104], [-0.33408, 0.00104]]),
            4: np.array([[0.70998, -0.00119], [-0.42426, 0.00119]]),
        }
